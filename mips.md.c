%{
#define INTTMP 0x0300ff00	// r8~r15, r24~r25 临时寄存器(整数)
#define INTVAR 0x40ff0000	// r16~r23, r30	寄存器变量(整数)
#define FLTTMP 0x000f0ff0	// f4~f10, f16~f18 临时寄存器(浮点)
#define FLTVAR 0xfff00000	// f20~f30　寄存器变量(浮点)

#define INTRET 0x00000004	// r3 函数返回值(整型)
#define FLTRET 0x00000003	// f2 函数返回值(浮点)
...
static Symbol ireg[32], freg2[32], d6;	// d6 == {r6, r7}
